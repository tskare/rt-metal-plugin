...
int main(int argc, char* argv[]) {
  ...
  // You'll also need it for tests that rely on juce::Graphics, juce::Timer,
  // etc. It's nicer DX when placed here vs. manually in Catch2 SECTIONs
